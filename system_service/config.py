...
SOC_TIMEOUT = float(os.getenv('SUPERVISOR_SOC_TIMEOUT', '3.0'))
SOC_URL = os.getenv('SUPERVISOR_SOC_URL')
SOC_USER = os.getenv('SUPERVISOR_SOC_USER', None)
SOC_PASS = os.getenv('SUPERVISOR_SOC_PASS', None)