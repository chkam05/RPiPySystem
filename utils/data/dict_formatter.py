...
class DictFormatter:
    ...
    def clean_dict(
        ...
        """Return a dictionary with all null values removed except paths explicitly allowed."""
        if obj is None:
            return None
    ...
    def clean_list(
        ...
        """Return a list with all null values removed except paths explicitly allowed."""
        if obj is None:
            return None
