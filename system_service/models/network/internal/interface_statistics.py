...
from .interface_channel import InterfaceChannel
from utils.models.public_model import PublicModel


T = TypeVar('T', bound='InterfaceStatistics')


@dataclass
class InterfaceStatistics(PublicModel):
    ...
    @classmethod
    def from_dict(cls: Type[T], d: Dict[str, Any]) -> InterfaceStatistics:
